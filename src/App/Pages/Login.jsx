    ...
    return (
        <div className="d-flex flex-column flex-root" id="kt_app_root" style={{ height: '100vh' }}>
            <div className="d-flex flex-column flex-lg-row flex-column-fluid">
                ...
                <div className="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style={{backgroundImage: `url(${Helper.staticImage('assets/images/auth-bg.jpg')})`}}>
                    <div className="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">          
                        <a href="/" className="mb-0 mb-lg-12">
                            <img alt="Logo" src={Helper.staticImage("assets/logo-dark.png")} className="h-30px h-lg-30px"/>
                        </a>    

                        <img className="d-none d-lg-block mx-auto w-275px w-md-50 w-xl-500px mb-10 mb-lg-20" src={Helper.staticImage("assets/images/auth-bg-front.webp")} alt=""/>                 
                        ...
                        <div className="d-none d-lg-block text-white fs-base text-center">
                            This management is system is created by <a href="https://cyberify.co" target="_blank" className="opacity-75-hover text-warning fw-bold me-1">Cyberify</a> 
